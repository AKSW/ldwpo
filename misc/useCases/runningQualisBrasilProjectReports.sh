...
java -jar tools/reportgen.jar "ontology/ldwpo.owl" "ldwpo:project_QualisBrasil_to_DBpedia_Interlinking" > reports/report_QualisBrasilnterlinkProject.html.html
