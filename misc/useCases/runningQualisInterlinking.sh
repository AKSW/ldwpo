...
java -jar tools/ldStackWorkflow.jar "/home/srautenberg/Public/LDWPO/ontology/ldwpo.owl" "ldwpo:project_QualisBrasil_to_DBpedia_Interlinking" "ldwpo:ldWorkflow_execution_interlinking_qualisbrasil_20150126" > reports/workflowInterlink.html
